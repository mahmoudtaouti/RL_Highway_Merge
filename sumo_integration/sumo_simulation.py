...
# https://sumo.dlr.de/docs/Definition_of_controlled_vehicles,_Vehicle_Types,_and_Routes.html#abstract_vehicle_class
...
class SumoSimulation(object):
    ...
    def __init__(self, cfg_file, step_length, host=None, port=None, sumo_gui=False, client_order=1):
        ...
        # Structures to keep track of the spawned and destroyed controlled_vehicles at each time step.
